  ...
  const Form = () => {
    ...
    return type === "delete" && id ? (
      ...
      typeof forms[table] === "function" ? (
        ...
        <div className="p-4">
          <h2 className="text-lg font-semibold">Form not implemented</h2>
          <p className="text-sm text-gray-600">The form for <strong>{table}</strong> is not implemented yet.</p>
          <p className="text-sm text-gray-600 mt-2">You can assign a teacher from the Assign Teacher page, then return here to mark attendance.</p>
        </div>
      )
    ) : (
      "Form not found!"
